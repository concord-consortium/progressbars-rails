...
Gem::Specification.new do |spec|
  spec.name          = "progressbars-rails"
  spec.version       = Progressbars::Rails::VERSION
  spec.authors       = ["Noah Paessel"]
  spec.email         = ["knowuh@gmail.com"]
  spec.summary       = %q{Rails Asset and helpers for progress bars}
  spec.description   = %q{Rails Asset and helpers for progress bars}
  spec.homepage      = ""
  spec.license       = "MIT"
